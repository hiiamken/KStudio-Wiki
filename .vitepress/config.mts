        ...
        nav: [
          { text: 'Home', link: '/' },
          {
            ...
            items: [
              ...
              { text: 'Configuration', link: '/ultradungeon/config/config-yml' },
            ],
          },
          {
            text: 'UltraCoinFlip',
            items: [
              ...
              { text: 'Configuration', link: '/ultracoinflip/config/config-yml' },
            ],
          },
        ],
        sidebar: {
        ...
        nav: [
          { text: 'Trang chủ', link: '/vi/' },
          {
            ...
            items: [
              ...
              { text: 'Cấu hình', link: '/vi/ultradungeon/config/config-yml' },
            ],
          },
          {
            text: 'UltraCoinFlip',
            items: [
              ...
              { text: 'Cấu hình', link: '/vi/ultracoinflip/config/config-yml' },
            ],
          },
        ],
        sidebar: {
          '/vi/ultradungeon/guide/': [
            {
              text: 'Giới thiệu',
              items: [
                { text: 'Bắt đầu', link: '/vi/ultradungeon/guide/getting-started' },
